...
/*    public void MessageBool(string item, bool value)
    ...
    public string SceneToAreaMapping(string sceneName)
    {
      var roomMappings = new Dictionary<string, string>(){
        ...
        {"Room_Fungus_Shaman", "Overgrown_Mound??????"},
        {"Fungus3_archive", "Fog_Canyon"},
        {"Fungus3_archive_02", "Fog_Canyon"},
        {"Fungus2_01", "Queens_Station???????"},
        {"Fungus2_02", "Queens_Station????????"},
        {"Fungus2_34", "Queens_Station????????"},
